# genpark-multi-model-cost-latency-price-performance-router-skill
...
> **GenPark AI Agent Skill** -- Real-time cross-provider LLM price-performance cost estimator & dynamic router
